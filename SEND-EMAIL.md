...
npx supabase secrets set BREVO_API_KEY="xkeysib-คีย์จริง" SENDER_EMAIL="nattha.b@somapait.com" SENDER_NAME="OSO Evaluation by IMM" --project-ref hokuuilqvfdeekchqelz
...
## หมายเหตุ
- ลบความลับ SMTP เก่าได้ (ไม่ใช้แล้ว): `npx supabase secrets unset SMTP_HOST SMTP_PORT SMTP_USER SMTP_PASS SMTP_FROM --project-ref hokuuilqvfdeekchqelz`
